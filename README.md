...
information required for us to confirm the vulnerability. This includes: 
 ...
 3. A clear, concise, and comprehensible description of the vulnerability along 
...
accepted and rewarded.
 ...
 before submission.
 7. Avoid unverified or speculative claims. Each reported issue must 
 be based on verified evidence with a clear reproduction demonstrating 
 the vulnerability. Reports containing primarily unsupported or 
 hypothetical claims (often AI-generated) may be deprioritized or rejected.
